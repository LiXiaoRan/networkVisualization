...
* @Last Modified time: 2018-11-24 22:54:08
*/
const d3 = require('d3')
...
export default class TimeLine {
  ...
  drawView(view) {
    ...
    let yAxis = d3.axisLeft().scale(yScale).ticks(3).tickSize(2)
    //  主时间轴
    ...
    function initMainTimeline() {
      ...
      let gridtick = container.append('g')
      ...
      gridtick.selectAll('path')
      .attr('stroke', 'gray')
      .attr('stroke-opacity', 0.1)

      gridtick.selectAll('line')
      .attr('stroke', 'gray')
      .attr('stroke-opacity', 0.1)
      ...
      let yaxis = container.append('g')
        ...
        .call(d3.axisLeft().scale(yScale).ticks(3).tickSize(2))
    ...
    let gridtick = containerDetail.append('g')
      .attr('class', 'axis axis--grid')
      .attr('transform', 'translate(0,' + height + ')')
    ...
    let xaxis = containerDetail.append('g')
      .attr('class', 'axis axis--x')
      .attr('transform', 'translate(0,' + height + ')')
      .call(d3.axisBottom(xScale2)
        .ticks(d3.timeHour.every(3))
    ...
    let yaxis = containerDetail.append('g')
      .attr('class', 'y axis')
      .attr('transform', 'translate(0,0)')
      .call(yAxis)
    yaxis.selectAll('text')
