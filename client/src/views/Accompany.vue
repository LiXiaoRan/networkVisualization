<template>
  <div id="main">
  <div id="left_accompany">
    <router-link target="_blank" to="/bipartiteGraph">
      <button class="analysis-btn" style="display: none">层间关系分析</button>
    </router-link>
  </div>
  <div id="right_detail">
    <div id = "title"></div>
    ...
    mounted() {
      ...
      function drawLowerTimeLine(datap) {
        ...
        var xaxis = context.append("g")
          ...
          .call(context_xAxis);
        xaxis.selectAll(".tick text").attr("transform", "translate(0," + 5 + ")").attr("fill",'#959595');
        d3.selectAll(".tick text").attr("fill",'#959595')
      ...
      function brushend() {
        ...
        //  console.log(nodeArray)
         ...
         // console.log(accompanyRateArray);
          ...
          //绘制二部图
          $("#left_accompany .analysis-btn").show()
          window.drawBgData = brushArray;
          let draw_data = window.localStorage;
          draw_data['data'] = JSON.stringify(brushArray);
